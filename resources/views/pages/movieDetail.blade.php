...
@if(isset($data) && count($data) > 0)
    ...
    @else
    <div class="mov-detail flex-col sp-ar" style="background: url({{ asset('images/backdropPlaceholder.png') }}); background-repeat: no-repeat;" />
    @endif
        <div class="mov-content flex-row sp-be">
            <div class="mov-flex-1">
                <div class="mov-poster flex-col">
                    ...
                    <div class="watchlists-container">  
                        <form class="flex-row "style="margin-bottom: 10px;" method="POST" action="/watchlists/item">
                        @csrf
                            ...
                            @if(Session::has('message'))
                                <button type="submit" style="color: green; background: #dddddd; border: none; padding: 0 6px 0 6px; border-radius: 0 5px 5px 0;">{{ Session::get('message') }}</button>
                            @else
                        ...
                        @csrf
                            <div class="review-header">
                                ...
                                <div class="review-header">
                                    ...
                                    <div>
                                        <b style="font-size: 12px;">{{ $review['created_at'] }}</b>
